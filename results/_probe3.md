...
Generated: 2026-08-06 18:11:15 UTC
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `pessimistic` | on | 600 | 60 | **60** | 0 | ✅ HOLDS | 487 | 0 | 53 | 0 | **0** | 0 | 0 | 2363.2ms | 23383.7ms | 32583.2ms | 51.70s |
...
|---|---|---|---|---|---|
| `pessimistic` | on | 600 | **104** | 31.8s / 47.6s / 50.7s | 12 |
...
- Latency p50 / p95 / p99: 2363.2ms / 23383.7ms / 32583.2ms
- Wall time: 51.70s (12 req/s)
