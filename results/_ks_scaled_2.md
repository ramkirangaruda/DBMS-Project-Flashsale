...
Generated: 2026-08-06 18:05:37 UTC
...
- Front door: **waiting room ON** — buyers join `/queue/join/{sale_id}` and are admitted 2 every 0.5s (**4.0/s**)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `redis` | on | 300 | 300 | **299** | 0 | ✅ HOLDS | 0 | 0 | 1 | 0 | **0** | 0 | 0 | 1996.9ms | 10017.1ms | 11819.9ms | 31.61s |
...
|---|---|---|---|---|---|
| `redis` | on | 300 | **75** | 19.7s / 29.8s / 31.4s | 0 |
...
- Confirmed in database: **299** / 300 stock
- Confirmed seen by clients: 299
- Rejected as sold out: 0
- Aborted mid-flight (chaos): 0
- Failed / errored: 1
- Final availability — reported `1` (SQL `300`, Redis `1`)
...
- Latency p50 / p95 / p99: 1996.9ms / 10017.1ms / 11819.9ms
- Wall time: 31.61s (9 req/s)
