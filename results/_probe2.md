...
Generated: 2026-08-06 18:09:37 UTC
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `redis` | on | 300 | 300 | **300** | 0 | ✅ HOLDS | 0 | 0 | 0 | 0 | **0** | 0 | 0 | 1640.5ms | 14638.0ms | 20458.6ms | 27.71s |
...
|---|---|---|---|---|---|
| `redis` | on | 300 | **64** | 17.4s / 26.9s / 27.6s | 0 |
...
- Latency p50 / p95 / p99: 1640.5ms / 14638.0ms / 20458.6ms
- Wall time: 27.71s (11 req/s)
