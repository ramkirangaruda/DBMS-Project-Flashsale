...
Generated: 2026-08-06 18:07:47 UTC
...
- Front door: **waiting room ON** — buyers join `/queue/join/{sale_id}` and are admitted 25 every 0.5s (**50.0/s**)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `redis` | on | 300 | 300 | **300** | 0 | ✅ HOLDS | 0 | 0 | 0 | 0 | **0** | 0 | 0 | 1440.3ms | 10646.4ms | 13595.4ms | 20.11s |
...
|---|---|---|---|---|---|
| `redis` | on | 300 | **75** | 10.5s / 18.7s / 19.8s | 0 |
...
- Latency p50 / p95 / p99: 1440.3ms / 10646.4ms / 13595.4ms
- Wall time: 20.11s (15 req/s)
