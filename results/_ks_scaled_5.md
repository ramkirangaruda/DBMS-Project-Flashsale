...
Generated: 2026-08-06 18:06:26 UTC
...
- Front door: **waiting room ON** — buyers join `/queue/join/{sale_id}` and are admitted 5 every 0.5s (**10.0/s**)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `redis` | on | 300 | 300 | **300** | 0 | ✅ HOLDS | 0 | 0 | 0 | 0 | **0** | 0 | 0 | 1398.2ms | 12038.0ms | 15619.1ms | 24.39s |
...
|---|---|---|---|---|---|
| `redis` | on | 300 | **78** | 14.9s / 22.4s / 23.8s | 0 |
...
- Latency p50 / p95 / p99: 1398.2ms / 12038.0ms / 15619.1ms
- Wall time: 24.39s (12 req/s)
