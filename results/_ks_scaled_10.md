...
Generated: 2026-08-06 18:07:05 UTC
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `redis` | on | 300 | 300 | **300** | 0 | ✅ HOLDS | 0 | 0 | 0 | 0 | **0** | 0 | 0 | 1375.4ms | 8811.2ms | 14176.5ms | 18.73s |
...
|---|---|---|---|---|---|
| `redis` | on | 300 | **77** | 10.3s / 17.2s / 18.5s | 0 |
...
- Latency p50 / p95 / p99: 1375.4ms / 8811.2ms / 14176.5ms
- Wall time: 18.73s (16 req/s)
